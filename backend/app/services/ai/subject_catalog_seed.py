...
def codes_for_exam(exam_type: str, branch: str | None) -> set[str] | None:
    ...
    if et in {"yks", "tyt", "ayt"}:
        codes = set(TYT_SUBJECT_CODES)
        if et == "tyt":
            return codes
        if et == "ayt":
            if br and br in YKS_AYT_BY_BRANCH:
                return set(YKS_AYT_BY_BRANCH[br])
            # No branch: do not dump all AYT tracks
            return set()
        # yks: TYT always + AYT for branch only
        if br and br in YKS_AYT_BY_BRANCH:
...
SUBJECT_CATALOG_SEED: list[dict[str, Any]] = [
    ...
    {"code": "ayt_yabanci_dil", "name": "Yabancı Dil", "exam_types": ["yks", "ayt"], "sort_order": 230, "section": "ayt", "is_active": True},
    ...
    # KPSS — ders odaklı
    {"code": "kpss_turkce", "name": "Türkçe", "exam_types": ["kpss"], "sort_order": 10, "section": None, "is_active": True},
    {"code": "kpss_matematik", "name": "Matematik", "exam_types": ["kpss"], "sort_order": 20, "section": None, "is_active": True},
    {"code": "kpss_tarih", "name": "Tarih", "exam_types": ["kpss"], "sort_order": 30, "section": None, "is_active": True},
    {"code": "kpss_cografya", "name": "Coğrafya", "exam_types": ["kpss"], "sort_order": 40, "section": None, "is_active": True},
    {"code": "kpss_vatandaslik", "name": "Vatandaşlık", "exam_types": ["kpss"], "sort_order": 50, "section": None, "is_active": True},
    {"code": "kpss_guncel", "name": "Güncel Bilgiler", "exam_types": ["kpss"], "sort_order": 60, "section": None, "is_active": True},
    ...
    # YDS
    {"code": "yds_vocabulary", "name": "Vocabulary", "exam_types": ["yds"], "sort_order": 10, "section": None, "is_active": True},
    {"code": "yds_grammar", "name": "Grammar", "exam_types": ["yds"], "sort_order": 20, "section": None, "is_active": True},
    {"code": "yds_reading", "name": "Reading", "exam_types": ["yds"], "sort_order": 30, "section": None, "is_active": True},
    {"code": "yds_cloze", "name": "Cloze Test", "exam_types": ["yds"], "sort_order": 40, "section": None, "is_active": True},
    {"code": "yds_sentence_completion", "name": "Sentence Completion", "exam_types": ["yds"], "sort_order": 50, "section": None, "is_active": True},
    {"code": "yds_translation", "name": "Translation", "exam_types": ["yds"], "sort_order": 60, "section": None, "is_active": True},
    {"code": "yds_dialogue", "name": "Dialogue", "exam_types": ["yds"], "sort_order": 70, "section": None, "is_active": True},
    {"code": "yds_paragraph", "name": "Paragraph", "exam_types": ["yds"], "sort_order": 80, "section": None, "is_active": True},
    {"code": "yds_meaning", "name": "Meaning", "exam_types": ["yds"], "sort_order": 90, "section": None, "is_active": True},
    {"code": "yds_listening", "name": "Listening", "exam_types": ["yds"], "sort_order": 100, "section": None, "is_active": True},
    # ALES / DGS
